...
Historical QA metrics from scans using the bullet phantom (orange) and the fBIRN phantom (blue) since 2022. The orange and blue lines represent 60-day smoothing. Orange and blue dots are individual QA scans. Red vertical lines indicate dates of gradient changes: 

* 2022-08-19
* 2023-11-25
* 2025-03-20
* 2025-07-23 -- new 20-channel head coil
...
```{r echo = FALSE}
knitr::include_graphics(file.path(figdir,'measure_drift_1-60_2-60_bullet.png'))
...
```{r echo = FALSE}
knitr::include_graphics(file.path(figdir,'measure_driftfit_1-60_2-60_bullet.png'))
...
```{r echo = FALSE}
knitr::include_graphics(file.path(figdir,'measure_percentFluc_1-60_2-60_bullet.png'))
...
```{r echo = FALSE}
knitr::include_graphics(file.path(figdir,'measure_rdc_1-60_2-60_bullet.png'))
...
```{r echo = FALSE}
knitr::include_graphics(file.path(figdir,'measure_SFNR_1-60_2-60_bullet.png'))
...
```{r echo = FALSE}
knitr::include_graphics(file.path(figdir,'measure_SNR_1-60_2-60_bullet.png'))
knitr::include_graphics(file.path(figdir,'measure_SNR_1-60_2-60_bullet_fbirn.png'))
```

## Site Comparisons

Scanner metrics are overlayed on QA data using the fBIRN phantom from thirteen sites. Sites performed monthly QA scans over 3-4 years. Sites are marked by color. For discussion, see:

Kayvanrad, A., et al. (2021). Resting state fMRI scanner instabilities revealed by longitudinal phantom scans in a multi-center study. *Neuroimage*, 237, 118197. doi: 10.1016/j.neuroimage.2021.118197.

NB: Lower is better for Drift, Drift (fit), and Percent Fluc.

Higher is better for RDC, SFNR, and SNR.

The most comparable site below is St. Mike’s Hospital, Toronto, in <b><span style=color:#D575FD>purple</span></b>, which used a Siemens Skyra with a 20-Ch Head Coil.

```{r echo = FALSE}
knitr::include_graphics(c(file.path(figdir,'measure_drift_1-60_2-60_bullet_fbirn_sites.png'), file.path(figdir,'measure_driftfit_1-60_2-60_bullet_fbirn_sites.png')))
knitr::include_graphics(c(file.path(figdir,'measure_percentFluc_1-60_2-60_bullet_fbirn_sites.png'), file.path(figdir,'measure_rdc_1-60_2-60_bullet_fbirn_sites.png')))
knitr::include_graphics(c(file.path(figdir,'measure_SNR_1-60_2-60_bullet_fbirn_sites.png'), file.path(figdir,'measure_SFNR_1-60_2-60_bullet_fbirn_sites.png')))
