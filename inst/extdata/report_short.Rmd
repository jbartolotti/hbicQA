...
Historical QA metrics from scans using the bullet phantom (orange) and the fBIRN phantom (blue) since 2022. The orange and blue lines represent 60-day smoothing. Orange and blue dots are individual QA scans. Red Xs indicate scans outside +/- 2SDs (based on mean and SD over the past 365 days).
