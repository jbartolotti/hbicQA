...
## 60 day trend  
Standardized QA metrics from past 60 days. Outlined dots are from the most recent QA scan (Green = within 2SD, Red = outside 2SD). Grey dots are scans within the past 60 days; Lighter grey = older scans. Shaded regions represent 1 and 2 SDs, based on QA data from the past 365 days. For Drift, Drift-Fit, and Percent Fluctuation, *lower is better*. For RDC, SFNR, and SNR, *higher is better*.
